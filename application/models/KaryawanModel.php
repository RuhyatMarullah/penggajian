...
class KaryawanModel extends CI_Model
{
	...
	public function lihat_karyawan()
	{
		...
		$this->db->join('pengguna', 'pengguna.pengguna_id = karyawan.karyawan_pengguna_id');
	...
	public function get_karyawan_by_pengguna($id)
	{
		$this->db->select('*');
		$this->db->from('karyawan');
		$this->db->join('jabatan', 'jabatan.jabatan_id = karyawan.karyawan_jabatan_id');
		$this->db->join('pengguna', 'pengguna.pengguna_id = karyawan.karyawan_pengguna_id');
		$this->db->where('karyawan_pengguna_id', $id);
		$query = $this->db->get();
		return $query->row_array();
	}
}
