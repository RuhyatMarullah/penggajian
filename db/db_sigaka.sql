...
INSERT INTO `hak_akses` (`hak_akses_id`, `hak_akses`) VALUES
(1, 'admin'),
(2, 'manajer'),
(3, 'karyawan');
...
INSERT INTO `pengguna` (`pengguna_id`, `pengguna_username`, `pengguna_password`, `pengguna_nama`, `pengguna_foto`, `hak_akses_id`, `pengguna_date_created`) VALUES
...
--
ALTER TABLE `pengguna`
  ADD CONSTRAINT `sigaka_pengguna_ibfk_1` FOREIGN KEY (`hak_akses_id`) REFERENCES `hak_akses` (`hak_akses_id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
