								...
								<div class="card-body">
									<div class="media d-flex">
										...
										<div class="media-body text-right mt-1">
											...
											<h6 class="mt-1"><span class="text-muted white">Jumlah Karyawan</h6>
										</div>
									</div>
								</div>
							</div>
						...
						<div class="card pull-up bg-gradient-directional-danger">
							<div class="card-header bg-hexagons-danger">
								...
								<div class="heading-elements">
									<ul class="list-inline mb-0">
										<li>
											<a class="btn btn-sm btn-white danger box-shadow-1 round pull-right" href="<?= base_url('absen') ?>">Lihat<i class="ft-arrow-right pl-1"></i></a>
										</li>
									</ul>
								</div>
							</div>
								...
								<div class="card-body">
									<div class="media d-flex">
										...
										<div class="media-body text-right mt-1">
											...
											<h6 class="mt-1"><span class="text-muted white">Absen karyawan
											</h6>
										</div>
									</div>
								</div>
						...
						<div class="card pull-up bg-gradient-directional-danger">
							<div class="card-header bg-hexagons-danger">
								...
								<div class="heading-elements">
									<ul class="list-inline mb-0">
										<li>
											<a class="btn btn-sm btn-white danger box-shadow-1 round pull-right" href="<?= base_url('laporan') ?>">Lihat<i class="ft-arrow-right pl-1"></i></a>
										</li>
									</ul>
								</div>
							</div>
							<div class="card-content collapse show bg-hexagons-danger">
								<div class="card-body">
									<div class="media d-flex">
										<div class="align-self-center width-100">
											<div><i class="ft-file" style="color: white;font-size: 700%"></i>
											</div>
										</div>
										<div class="media-body text-right mt-1">
											<br>
											<br>
											<h6 class="mt-1"><span class="text-muted white">Laporan gaji karyawan
											</h6>
										</div>
									</div>
								</div>
