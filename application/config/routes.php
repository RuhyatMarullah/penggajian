...
$route['gaji/bayar'] = 'GajiController/bayar';
...
$route['scan-qr-code'] = 'QrCodeController/scan_qr_code';

$route['absen'] = 'AbsenController';
$route['absen/tambah/(:any)'] = 'AbsenController/tambah/$1';
$route['absen/lembur/(:any)'] = 'AbsenController/lembur/$1';

$route['profile/(:any)'] = 'PenggunaController/profile/$1';
$route['edit-foto'] = 'PenggunaController/update_foto';
